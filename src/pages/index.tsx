	...
	return (
		<Layout sitetitle="Startseite" path="/">
			<div className="left right_sidebar_opposite">
				...
				<p>Diese Seite gibt's nur, weil viele Neugierige die Domain meiner Email-Adresse in den Browser tippen und dann enttäuscht sind, dass es keinen Inhalt gibt. Solltest Du auch auf diesem Wege zu mir gekommen sein:<br /><em>Fühl Dich gerne angesprochen!</em></p>
				<h2>Hire me</h2>
				<ul>
